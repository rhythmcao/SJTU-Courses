...
public class JF_view_sysset_subject extends JInternalFrame {
	...
	public void jBsave_actionPerformed(ActionEvent e) {
		int result = JOptionPane.showOptionDialog(null, "是否存盘考试科目信息数据?", "系统提示", JOptionPane.YES_NO_OPTION,
				JOptionPane.QUESTION_MESSAGE, null, new String[] { "是", "否" }, "否");
		if (result == JOptionPane.NO_OPTION)
			return;

		model.Obj_subject objsubject = new model.Obj_subject();
	...
	public void jBexit_actionPerformed(ActionEvent e) {
		...
		int result = JOptionPane.showOptionDialog(null, "是否退出考试科目信息设置?", "系统提示", JOptionPane.YES_NO_OPTION,
				JOptionPane.QUESTION_MESSAGE, null, new String[] { "是", "否" }, "否");
	...
	public void jBdel_actionPerformed(ActionEvent e) {
		int result = JOptionPane.showOptionDialog(null, "是否删除考试科目信息数据?", "系统提示", JOptionPane.YES_NO_OPTION,
				JOptionPane.QUESTION_MESSAGE, null, new String[] { "是", "否" }, "否");
		if (result == JOptionPane.NO_OPTION)
			return;
		String sqlDel = "delete from tb_subject where code = '" + jTextField1.getText().trim() + "'";
		JdbcAdapter jdbcAdapter = new JdbcAdapter();
